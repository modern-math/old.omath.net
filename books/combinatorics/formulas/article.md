...
@mermaid
    flowchart TB
        ...
        root -->|Свести к типовым комбинациям| configurations[Комбинаторные конфигурации]:::featured
...
Сначала ведутся расчеты в этих подзадачах, а потом их результаты складываются и получается ответ на основную задачу.
...
Схема основных комбинатоных конфигураций с формулами:
